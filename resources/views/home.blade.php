        ...
        <div class="row p-5">
            <div class="col-lg-6">
                <div class="card mb-4 shadow">
                    <img src="{{ asset('assets/images/coworkingspace.png') }}" class="card-img-top" alt="Card Image">
                    <div class="card-body">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card mb-4 border-0">
          <div class="card-body text-center">
            ...
            <p class="card-text">Cari Coworking space sesuai kebutuhan dan booking tempat lebih cepat.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card mb-4 border-0">
          <div class="card-body text-center">
            <image src="{{ asset('assets/images/icon3.png') }}" alt="Kuota Terupdate" class="img-fluid mb-4">
            <h5 class="card-title">Kuota Terupdate</h5>
            <p class="card-text">Kuota working space akan selalu terupdate tiap terjadi reservasi pada website.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container bg-primary text-white rounded p-0 d-flex justify-content-center">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 p-5">
                <img src="{{ asset('assets/images/LOGO SPACEBOOK WHITE.png') }}" class="mb-4" alt="Bootstrap" width="170.04px" height="66.53px">
                <h2 class="fw-bold lh-base">Apa itu Spacebook</h2>
                <h5 class="fw-light lh-lg mt-3">SpaceBook adalah platform yang menyediakan informasi terlengkap mengenai coworking space/meeting room sehingga reservasi ruangan menjadi lebih mudah</h5>
            </div>
        </div>
    </div>
</section>
