...
@section('content')
    <div class="container-fluid">
        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="p-3 mt-2">
                                    <form method="POST" action="{{ route('admin.register.store') }}">
                                        ...
                                        <button type="submit"
                                            class="btn btn-secondary text-light fw-bold w-100">Daftar</button>
                                        <div class="fs-7 text-center mt-3">Sudah punya akun? <a
                                                href="{{ route('admin.login') }}" class="fw-bold text-dark">Masuk</a></div>
                                    </form>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6 bg-primary p-5 right-side-a d-flex align-items-center justify-content-center">
